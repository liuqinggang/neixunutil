...
public class CacheKit {
    ...
    public Object get(String key) {
        // return jdkSerializationRedisSerializer.deserialize(jedis.get(key.getBytes()));
    ...
    public void setObject(String key, int seconds, Object value) {
        //jedis.setex(key.getBytes(),seconds,jdkSerializationRedisSerializer.serialize(value));
